...
import { createInitialSave, getUnlockedTrickIds } from '../src/game/bootstrap.ts'
  ...
  return {
    ...
    progress: {
      ...
      trickProgress: Object.fromEntries(
        Object.entries(save.progress.trickProgress).map(([trickId, progress]) => [
          trickId,
          {
            ...progress,
...
describe('resolveTurn', () => {
  ...
  test('converts earned turn points into extra turns', () => {
    ...
    expect(next.run.nextTurnThreshold).toBe(200)
